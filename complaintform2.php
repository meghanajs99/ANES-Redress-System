...
$sql = "INSERT INTO complaints (id,department, roomno, type, description,status)
 VALUES ('','$dept', '$roomno', '$type', '$desc','complaint registered')";
...
<input name="Done" class="buttonSave" type="button" onclick="window.location.replace('http://localhost/cms/complaintstatus.php')" value="Done" 
				id="Done" >
<input name="Rechange" class="buttonSave" type="button" onclick="window.location.replace('http://localhost/cms/complaintform.php')" value="Resubmit" 
				id="Resubmit" >
</body>
</html>